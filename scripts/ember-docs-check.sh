...
required_docs='architecture.md cli-reference.md lifecycle-and-blobs.md deployment-and-recovery.md azure-shaped-compatibility.md sprint-2-release-evidence.md sprint-2-closeout.md sprint-2-resource-blob-evidence.md sprint-2-queue-event-evidence.md tenant-resource-release-evidence.md'
...
grep -Fq -- 'platform.db' "$ROOT/docs/tenant-resource-release-evidence.md"
grep -Fq -- 'tenant.db' "$ROOT/docs/tenant-resource-release-evidence.md"
grep -Fq -- 'modernc.org/sqlite' "$ROOT/docs/tenant-resource-release-evidence.md"
